...
export default function Home() {
  ...
  return (
    ...
    <div className="relative h-[10000px]">
      <div className="absolute bg-[url('/gradients/front-page-gradient.svg')] w-screen h-screen flex flex-col items-center">
        <div className="relative font-clash font-medium top-[15%] text-8xl">Data At UCI</div>
      </div>
        <Navbar></Navbar>
    </div>
  )
