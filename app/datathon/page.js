  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          top: 583 + WAVE_OFFSET - 1,
          background: `linear-gradient(to bottom, ${BASE_BLUE} 0%, rgba(90,130,224,0) 100%)`,
        }}
      />
    </motion.div>
  );
...
const TextBubble = ({ text, className = '', delay = 0, flip = false }) => {
  return (
    ...
    >
      <Image alt="textbox" src={textbox} className={`hidden lg:block w-full h-auto ${flip ? '-scale-x-100' : ''}`} />
  ...
  const bubbles = [
    {
      ...
      className: 'w-[300px] top-[10px] left-1/2 -translate-x-1/2 lg:top-[-80px] lg:left-[200px] lg:translate-x-0 z-10',
      delay: 0.2,
    },
    {
      text: 'Team up with mentors and peers to learn fast and build something meaningful.',
      className: 'w-[300px] top-[110px] left-1/2 -translate-x-1/2 lg:top-[-40px] lg:left-auto lg:right-[12%] lg:translate-x-0 z-10',
      delay: 0.3,
      flip: true,
    },
    {
      text: 'Clean, explore, and model with Python/SQL/ML—ask mentors anytime.',
      className: 'w-[320px] top-[210px] left-1/2 -translate-x-1/2 lg:top-[50px] lg:left-[30%] lg:translate-x-0 z-10',
      delay: 0.4,
    },
    {
      text: 'Submit a notebook + slides and present to judges.',
      className: 'w-[300px] top-[310px] left-1/2 -translate-x-1/2 lg:top-[110px] lg:left-auto lg:right-[20%] lg:translate-x-0 z-10',
      delay: 0.5,
      flip: true,
    },
    {
      text: 'Tracks span health, finance, and more—pick a challenge and dive in.',
      className: 'w-[300px] top-[410px] left-1/2 -translate-x-1/2 lg:top-[190px] lg:left-[12%] lg:translate-x-0 z-10',
      delay: 0.6,
    },
    {
      text: 'Workshops, mentorship, prizes, food—and a portfolio-ready project.',
      className: 'w-[320px] top-[490px] left-1/2 -translate-x-1/2 lg:top-[250px] lg:left-auto lg:right-[8%] lg:translate-x-0 z-10',
      delay: 0.7,
      flip: true,
    },
  ];
  ...
  return (
    <div className="relative w-screen min-h-screen pt-[140px] bg-gradient-to-b from-[#4E74D9] via-[#7FA1E6] to-[#CAD8E6]">
      <motion.div className="w-full h-auto relative" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
        ...
        <motion.div
          className="absolute left-[5%] top-[190px] max-w-[640px] pt-30 pr-6 z-10"
          initial={{ opacity: 0, y: 8 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.5 }}
        >
          <p className="text-white leading-relaxed font-mono">
            A datathon is a fast-paced, team-based event where you dig into real datasets, uncover insights, and present your findings.
            Think hackathon—but focused on data exploration, analysis, and storytelling with tools like Python, SQL, and ML.
          </p>
        </motion.div>
      </motion.div>
      ...
      >
        <div className="relative w-full">
          {bubbles.map((b, i) => (
            <TextBubble key={i} text={b.text} className={b.className} delay={b.delay} flip={!!b.flip} />
          ))}
        </div>
...
const content = [
  {
    ...
    content: <div className="h-full w-full bg-[url('/photos/datathon3.png')] bg-cover flex items-center justify-center text-white font-mono">Datathon 2024</div>,
  },
  {
    ...
    content: <div className="h-full w-full bg-[url('/photos/datathon4.png')] bg-cover flex items-center justify-center text-white font-mono">Datathon 2024</div>,
  },
  {
    ...
    content: <div className="h-full w-full bg-[url('/photos/datathon5.png')] bg-cover flex items-center justify-center text-white font-mono">Datathon 2024</div>,
  },
  {
    ...
    content: <div className="h-full w-full bg-[url('/photos/datathon1.png')] bg-cover flex items-center justify-center text-white font-mono">Embark 2023</div>,
  },
  {
    title: 'Sponsors',
    description:
    ...
    content: <div className="h-full w-full bg-[url('/photos/datathon2.png')] bg-cover flex items-center justify-center text-white font-mono">Embark 2023</div>,
  },
];
